<section class="bg-white border rounded-xl mb-6">
    <header class="px-6 py-4 border-b flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <button type="button" data-staff-payroll-refresh-scope="periods" class="inline-flex items-center gap-1.5 justify-center px-3 py-2 text-xs rounded-md border border-slate-300 bg-white text-slate-700 hover:bg-slate-50">
    ...
    <div class="px-6 pb-4 flex items-center justify-between gap-3 text-sm">
        <p class="text-gray-500">Page <?= (int)($staffPayrollPeriodsPagination['page'] ?? 1) ?></p>
        <div class="flex items-center gap-2">
            <button type="button" data-staff-payroll-page-scope="periods" data-staff-payroll-page="<?= max(1, ((int)($staffPayrollPeriodsPagination['page'] ?? 1)) - 1) ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollPeriodsPagination['has_prev']) ? '' : 'disabled aria-disabled="true"' ?>>Previous</button>
            <button type="button" data-staff-payroll-page-scope="periods" data-staff-payroll-page="<?= ((int)($staffPayrollPeriodsPagination['page'] ?? 1)) + 1 ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollPeriodsPagination['has_next']) ? '' : 'disabled aria-disabled="true"' ?>>Next</button>
        </div>
    </div>
</section>
...
<section class="bg-white border rounded-xl mb-6">
    <header class="px-6 py-4 border-b flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2 justify-end">
            <button type="button" data-staff-payroll-refresh-scope="adjustments" class="inline-flex items-center gap-1.5 justify-center px-3 py-2 text-xs rounded-md border border-slate-300 bg-white text-slate-700 hover:bg-slate-50">
                <span class="material-symbols-outlined text-[14px]">refresh</span>
                Refresh Table
            </button>
    ...
    <div class="px-6 pb-4 flex items-center justify-between gap-3 text-sm">
        <p class="text-gray-500">Page <?= (int)($staffPayrollAdjustmentsPagination['page'] ?? 1) ?></p>
        <div class="flex items-center gap-2">
            <button type="button" data-staff-payroll-page-scope="adjustments" data-staff-payroll-page="<?= max(1, ((int)($staffPayrollAdjustmentsPagination['page'] ?? 1)) - 1) ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollAdjustmentsPagination['has_prev']) ? '' : 'disabled aria-disabled="true"' ?>>Previous</button>
            <button type="button" data-staff-payroll-page-scope="adjustments" data-staff-payroll-page="<?= ((int)($staffPayrollAdjustmentsPagination['page'] ?? 1)) + 1 ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollAdjustmentsPagination['has_next']) ? '' : 'disabled aria-disabled="true"' ?>>Next</button>
        </div>
    </div>
</section>
...
<section class="bg-white border rounded-xl mb-6">
    <header class="px-6 py-4 border-b flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <button type="button" data-staff-payroll-refresh-scope="runs" class="inline-flex items-center gap-1.5 justify-center px-3 py-2 text-xs rounded-md border border-slate-300 bg-white text-slate-700 hover:bg-slate-50">
            <span class="material-symbols-outlined text-[14px]">refresh</span>
            Refresh Table
        </button>
    </header>
    ...
    <div class="px-6 pb-4 flex items-center justify-between gap-3 text-sm">
        <p class="text-gray-500">Page <?= (int)($staffPayrollRunsPagination['page'] ?? 1) ?></p>
        <div class="flex items-center gap-2">
            <button type="button" data-staff-payroll-page-scope="runs" data-staff-payroll-page="<?= max(1, ((int)($staffPayrollRunsPagination['page'] ?? 1)) - 1) ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollRunsPagination['has_prev']) ? '' : 'disabled aria-disabled="true"' ?>>Previous</button>
            <button type="button" data-staff-payroll-page-scope="runs" data-staff-payroll-page="<?= ((int)($staffPayrollRunsPagination['page'] ?? 1)) + 1 ?>" class="px-3 py-1.5 border rounded-md text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" <?= !empty($staffPayrollRunsPagination['has_next']) ? '' : 'disabled aria-disabled="true"' ?>>Next</button>
        </div>
    </div>
</section>
        ...
        <form id="computePayrollForm" method="POST" action="payroll-management.php" class="px-6 py-4 space-y-4 text-sm">
            ...
            <div>
                ...
                <div class="mt-2 flex items-center justify-between gap-3 text-xs">
                    <p id="computePayrollEmployeeCount" class="text-slate-500">0 employee(s)</p>
                    <div class="flex items-center gap-2">
                        <button type="button" id="computePayrollPrevPage" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Previous</button>
                        <span id="computePayrollPageLabel" class="text-slate-500 min-w-[72px] text-center">Page 1</span>
                        <button type="button" id="computePayrollNextPage" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Next</button>
                    </div>
                </div>
            </div>
            ...
            <form id="generatePayslipForm" method="POST" action="payroll-management.php" class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="mt-3 flex items-center justify-between gap-3 text-xs">
                        <p class="text-slate-500">Payroll item review rows</p>
                        <div class="flex items-center gap-2">
                            <button type="button" id="generatePayslipBreakdownPrev" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Previous</button>
                            <span id="generatePayslipBreakdownPageLabel" class="text-slate-500 min-w-[72px] text-center">Page 1</span>
                            <button type="button" id="generatePayslipBreakdownNext" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Next</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="mt-3 flex items-center justify-between gap-3 text-xs">
                        <p class="text-slate-500">Submitted salary adjustment rows</p>
                        <div class="flex items-center gap-2">
                            <button type="button" id="generatePayslipAdjustmentPrev" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Previous</button>
                            <span id="generatePayslipAdjustmentPageLabel" class="text-slate-500 min-w-[72px] text-center">Page 1</span>
                            <button type="button" id="generatePayslipAdjustmentNext" class="px-2.5 py-1 border rounded-md text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed">Next</button>
                        </div>
                    </div>
                </div>
