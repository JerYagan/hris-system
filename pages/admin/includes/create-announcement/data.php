...
$announcementMetrics = buildPublishedAnnouncementMetrics($announcementLogs);
...
$announcementRows = (array)($announcementMetrics['rows'] ?? []);
$totalPublished = (int)($announcementMetrics['total_published'] ?? 0);
$totalInAppSent = (int)($announcementMetrics['total_in_app_sent'] ?? 0);
$totalEmailSent = (int)($announcementMetrics['total_email_sent'] ?? 0);
