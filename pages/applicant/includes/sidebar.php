  ...
  <div class="px-4 pb-4 border-b">
    <div class="flex items-center gap-3">
      <div class="flex items-center gap-2">
        ...
        <img src="../../assets/images/ati-logo/logo.png" alt="ATI HRIS Portal" class="h-8 w-8 object-contain">
      </div>
      <div>
        <h1 class="text-sm font-semibold text-gray-800 leading-tight">ATI HRIS Portal</h1>
