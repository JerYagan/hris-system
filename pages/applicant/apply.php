...
<div class="fixed inset-0 z-40 bg-gray-900/30"></div>

<!-- FULL-PAGE APPLY MODAL -->
<section class="fixed inset-0 z-50 p-3 sm:p-6">
    <form action="#" method="POST" enctype="multipart/form-data" class="mx-auto flex h-full w-full max-w-6xl flex-col overflow-hidden rounded-2xl border bg-white shadow-xl">
        <header class="border-b px-5 py-4 sm:px-6 flex items-center justify-between gap-3">
            <div class="flex items-start gap-3">
                <span class="material-symbols-outlined text-green-700 text-3xl">edit_document</span>
                <div>
                    <h1 class="text-xl sm:text-2xl font-semibold text-gray-800">Job Application Form</h1>
                    <p class="text-sm text-gray-500">Complete the form below to apply for the selected position.</p>
                </div>
            </div>
        ...
        <div class="flex-1 overflow-y-auto bg-gray-50 p-4 sm:p-6 space-y-6">
            <!-- POSITION INFO -->
            ...
            <section class="bg-white border rounded-xl">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full mt-1 border rounded-md px-3 py-2">
                    </div>
            ...
            <section class="bg-white border rounded-xl">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" min="0" class="w-full mt-1 border rounded-md px-3 py-2">
                    </div>
                </div>
            </section>
            ...
            <section class="bg-white border rounded-xl">
                ...
                <div class="p-6 text-sm">
                    ...
                    <textarea rows="3" class="w-full mt-1 border rounded-md px-3 py-2"></textarea>
                </div>
            </section>
        ...
        <footer class="border-t bg-white px-5 py-3 sm:px-6 flex items-center justify-end gap-3">
            <a href="job-list.php"
