...
$employeeContext = function_exists('resolveEmployeeDashboardIdentityContextCached')
    ? resolveEmployeeDashboardIdentityContextCached($supabaseUrl, $headers, $employeeUserId)
    : resolveEmployeeDashboardIdentityContext($supabaseUrl, $headers, $employeeUserId);
