...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function applyLayout() {
    if (isOpen) {
      ...
      document.dispatchEvent(new CustomEvent("hris:sidebar-opened", { detail: { source: "sidebar" } }));
    } else {
...
if (profileToggle && profileMenu) {
  profileToggle.addEventListener("click", (e) => {
    ...
    if (!profileMenu.classList.contains("hidden")) {
      document.dispatchEvent(new CustomEvent("hris:profile-menu-opened", { detail: { source: "profile" } }));
    }
  });
